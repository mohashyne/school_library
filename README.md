...
"This project is all about crafting a school library app, and it kicks off with the implementation of classes to depict students and teachers. These classes will serve as the cornerstone for the app, paving the way for a user-friendly and efficient library experience."
...
```sh
  cd my-folder
  git https://github.com/mohashyne/school_library.git
```
...
Feel free to check the [issues page](https://github.com/mohashyne/school_library/issues).
